...
save_path = f'/mnt/gestalt/home/lonian/mamba/exp_results_prompt_30s/{folder_name}/{subfolder_name}/dac_token'
os.makedirs (save_path, exist_ok=True)

logger = create_logger(f'/mnt/gestalt/home/lonian/mamba/exp_results_prompt_30s/{folder_name}/{subfolder_name}')
